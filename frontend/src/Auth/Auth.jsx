...
const handleLogin = async()=>{
    try{
        ...
        const response = await axios.post("https://blog-website-ecru-theta.vercel.app/login",login)
...
const handleSignup = async ()=>{
    try{
     const response =  await axios.post('https://blog-website-ecru-theta.vercel.app/signup',signup)
     localStorage.setItem('user',JSON.stringify(response.data));
    setMuser(response.data);
     navigate('/');
     console.log(response.data);
